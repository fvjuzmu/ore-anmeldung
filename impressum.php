...
<head>
    <title>Ortsranderholung Mutterstadt - Impressum</title>
    ...
    <div id="header">
        ...
        <div id="menu">
            <ul>
                ...
                <li><a href="reservation.php">Anmeldung</a></li>
                <li><a href="information.php">Info</a></li>
                <li><a href="impressum.php" class="current">Kontakt</a></li>
            </ul>
        </div>
        <!-- end of menu -->
    ...
    <div id="content">
        <div class="content_section">
            ...
            <p>Klaus Schemmel<br />
                ...
                Oggersheimer Stra&szlig;e 10<br />
            ...
            <table>
                <tr>
                    <td><p>Telefon:</p></td>
                    <td><p>(06234) 94 64 17</p></td>
                </tr>
                <tr><td><p>E-Mail:</p></td>
                    <td><p>juzmu@gmx.de</p></td>
                </tr></table>
            <p> </p>
            <p>Quelle: <i>Erstellt mit dem <a href="/nofollow" href="http://www.e-recht24.de" >Impressum-Generator</a> der Kanzlei Siebert</i></p>
